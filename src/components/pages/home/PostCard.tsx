...
import AuthorAttribution from "./AuthorAttribution.tsx";
    ...
    <div>
      ...
      <div className="flex flex-col justify-between space-y-4 md:flex-row md:space-y-0">
        ...
        <div className="flex select-none justify-start space-x-2 md:hidden md:justify-end">
          {post.metadata.categories && post.metadata.categories.map((category: any) => <Tag key={category.title}>{category.title}</Tag>)}
        </div>
      </div>
      <div
